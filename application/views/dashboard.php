					...
					<div class="header-mobile py-3">
						...
						<div class="container d-flex flex-stack">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								<a href="../../demo9/dist/index.html">
									<img alt="Logo" src="<?= base_url("assets/media/logos/logo-demo9.svg") ?>" class="h-35px" />
								</a>
							</div>
							<!--end::Mobile logo-->
							<!--begin::Aside toggle-->
									...
									<div class="card mb-5 mb-xl-8">
										...
										<div class="card-header align-items-center border-0 mt-4">
											...
											<div class="card-toolbar">
												...
												<!--begin::Menu 1-->
												<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61cf1f3f6d0f8">
													<!--begin::Header-->
													<div class="px-7 py-5">
													...
													<div class="px-7 py-5">
														...
														<div class="mb-10">
															...
															<!--begin::Input-->
															<div>
																<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61cf1f3f6d0f8" data-allow-clear="true">
																	<option></option>
													...
													<div class="mt-5">
															...
															<div class="d-flex align-items-center me-2">
																...
																<div class="symbol symbol-50px me-3">
																	<div class="symbol-label bg-light">
																		<img src="<?= base_url("media/svg/brand-logos/plurk.svg") ?>" class="h-50" alt="" />
																	</div>
																</div>
																<!--end::Symbol-->
																<!--begin::Title-->
														...
														<div class="d-flex flex-stack">
															...
															<div class="d-flex align-items-center me-2">
																...
																<div class="symbol symbol-50px me-3">
																	<div class="symbol-label bg-light">
																		<img src="<?= base_url("media/svg/brand-logos/vimeo.svg") ?>" class="h-50" alt="" />
																	</div>
																</div>
																<!--end::Symbol-->
																<!--begin::Title-->
